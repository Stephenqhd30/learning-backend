package com.kc.learning.config.rabbitmq.defaultMq;

import com.kc.learning.config.rabbitmq.BaseCustomizeMqWithDelay;
import com.kc.learning.config.rabbitmq.condition.RabbitMqCondition;
...
/**
 * 默认的延迟队列实例配置
 * todo 建议自定义延迟队列实例时统一类名：xxxRabbitMqWithDelay，
 * 同时类注解、类结构以及类静态变量名和default_mq/DefaultRabbitMqWithDelay保持一致，
 * 便于日志查看以及使用工具类，最简单的创建方式就是复制default_mq/DefaultRabbitMqWithDelay到customize_mq
 * 中全局修改文件中的“default”单词；
 *
 * @author stephen qiu
 */
@Slf4j
