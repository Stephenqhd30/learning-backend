package com.kc.learning.generate;
...
public class CodeGenerator {
	...
	public static void main(String[] args) throws TemplateException, IOException {
		// 指定生成参数
		String packageName = "com.kc.learning";
		String dataName = "证书审核日志";
		String dataKey = "certificateReviewLogs";
		String upperDataKey = "CertificateReviewLogs";
