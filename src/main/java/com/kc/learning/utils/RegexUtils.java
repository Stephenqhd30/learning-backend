...
public class RegexUtils {
	...
	public static boolean checkUserName(String userName) {
		String regex = "^[\\u4E00-\\u9FA5]{2,10}(·[\\u4E00-\\u9FA5]{2,10}){0,2}$";
		return Pattern.matches(regex, userName);
	}
	
	
	public static boolean checkSchoolNumber(String schoolNumber) {
		String regex = "^\\d{10}$";
		return Pattern.matches(regex, schoolNumber);
	}
